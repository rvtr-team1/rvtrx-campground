...
export class SimplePaymentIntentComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.stripeTest = this.fb.group({
      ...
      amount: [1001, [Validators.required, Validators.pattern(/\d+/), Validators.minLength(1)]],
    });
  }
  ...
  createPaymentIntent(amount: number): Observable<PaymentIntent> {
    return this.http.post<PaymentIntent>(`${env.apiUrl}/create-payment-intent`, { amount });
  }
}
